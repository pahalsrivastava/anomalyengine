...
features = ['Inbound Octets', 'Outbound Octets', 'Inbound Errors', 'Outbound Errors', 'Inbound Error Rate', 'Outbound Error Rate', 'Traffic Rate', 'Admin Status']
...
print("Predictions on all devices:")
print(data[['Metric Name', 'Predicted Failure']].head())
